...
function adaptPlan({ tripId, ownerName, region, title, startDate, endDate, days, feedbackCount, saveCount, createdAt, savedTripId }) {
...
// 보관함(GET /saved-trips) 응답 → 피드 갤러리 카드(PlanFeedCard)와 같은 모양으로 변환.
...
export function adaptSavedTrip(entry) {
  return {
    ...
    copiedTripId: entry.copiedTripId ?? null,
