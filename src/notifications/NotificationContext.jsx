...
const T = {
  ko: { traveler: '여행자', dismiss: '알림 닫기' },
  en: { traveler: 'A traveler', dismiss: 'Dismiss notification' },
}
  ...
  return (
    <div className="noti-toast pointer-events-auto flex w-full max-w-sm items-start gap-3 rounded-2xl border border-slate-100 bg-surface p-3 pr-2 shadow-popup ring-1 ring-black/5">
      <span className="relative shrink-0">
        <Avatar user={{ name: notification.actor?.name || copy.traveler, profileImageUrl: notification.actor?.profileImageUrl }} size={36} />
      ...
      >
        <p className="text-[12.5px] leading-snug text-slate-800">{describeNotification(notification, language)}</p>
